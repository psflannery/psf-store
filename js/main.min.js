...
v=!v,a(e)}),
// on window resize
r.$window.on("resize",d(function(){o(r.$trigger.attr("data-target"))},200))}function a(t){var n=l("#overlay");if(t.addClass(c.IS_ANIMATING),v){if(u(!0,r.$body),r.$trigger.addClass(c.ACTIVE).attr("aria-expanded","true"),t.addClass(c.IN),n.length)return;
...
}else u(!1,r.$body),r.$trigger.removeClass(c.ACTIVE).attr("aria-expanded","false"),t.removeClass(c.IN);
...
// =================== private methods =================
function t(){a.$subMenu=l(".menu-item-has-children"),a.$menu=l(".navigation-menu > .menu-item"),a.$menuMask=l(".menu-mask"),a.$overlay=l(".site-content-overlay")}function n(){s(f)?(a.$subMenu.off("mouseenter"),a.$menu.off("mouseleave")):(a.$subMenu.on("mouseenter",function(){var t,n=l(this).find(".sub-menu").height()+79;//55
a.$menuMask.height(n).addClass(o.IN),a.$overlay.addClass(o.IN)}),a.$menu.on("mouseleave",function(){a.$menuMask.removeClass(o.IN),a.$overlay.removeClass(o.IN)}))}
// =================== public methods ==================
function e(){t(),n()}
// =============== export public methods ===============
var a={},o={IN:"in"};return{init:e}}(),c=function(){"use strict";
// =================== private methods =================
...
// =================== public methods ==================
function e(){t(),n(),(a.$carousel.length||a.$carouselWrap.length)&&(a.$carousel.flickity(i),a.$carouselWrap.flickity(r),a.$cellImage.unwrap())}
// =============== export public methods ===============
var a={},o=!!l("body").hasClass("single-product"),i={cellAlign:"left",contain:!0,fullscreen:o,imagesLoaded:!0,lazyLoad:2},r={cellAlign:"left",contain:!0,pageDots:!1,imagesLoaded:!0,lazyLoad:6};return{init:e}}(),p=function(){"use strict";
// =================== private methods =================
...
function a(){t(),n()}
// =============== export public methods ===============
var o={},i={IN:"in"},r=!1;return{init:a}}(),$=function(){"use strict";
// =================== private methods =================
...
function e(){t(),n()}
// =============== export public methods ===============
var a={},o={IN:"in"},i=!1;return{init:e}}(),h=function(){"use strict";
// =================== private methods =================
...
function o(){t(),n()}
// =============== export public methods ===============
var i={},r={ACTIVE:"checkout--active"};return{init:o}}(),C=function(){"use strict";
// =================== private methods =================
...
// =================== public methods ==================
function o(){t(),i.$stickyAddToCart.length&&(e(),n(),a())}
// =============== export public methods ===============
var i={},r={IN:"in"};return{init:o}}();
// You Ready for this?
l(document).ready(function(){o.init(),a.init(),i.init(),r.init(),c.init(),p.init(),m.init(),$.init(),h.init(),C.init(),
// Init tooltips
