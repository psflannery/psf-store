...
/* =================== public methods ================== */function r(){t(),n(),s(f)&&a()}
/* =============== export public methods =============== */var c={};return{init:r}}(),r=function(){"use strict";
/* =================== private methods ================= */
function t(){a.$subMenu=l(".menu-item-has-children"),a.$menu=l(".navigation-menu > .menu-item"),a.$menuMask=l(".menu-mask")}function n(){s(f)?(a.$subMenu.off("hover"),a.$menu.off("mouseleave")):(a.$subMenu.on("hover",function(){var t,n=l(this).find(".sub-menu").height()+79;//55
...
/* =============== export public methods =============== */var a={},o=!!l("body").hasClass("single-product"),i={cellAlign:"left",contain:!0,fullscreen:o},r={cellAlign:"left",contain:!0,pageDots:!1};return{init:e}}(),p=function(){"use strict";
// =================== private methods =================
