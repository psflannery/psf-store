...
function u(t){var n=l(window).width();return parseInt(n)<=parseInt(t)}
// Toogle scroll
function s(t,n){t?n.addClass("stop-scrolling"):n.removeClass("stop-scrolling")}
// Event throttling
...
v=!v,a(e)}),
// on window resize
r.$window.on("resize",d(function(){o(r.$trigger.attr("data-target"))},200))}function a(t){var n=l("#overlay");if(t.addClass(c.IS_ANIMATING),v){if(s(!0,r.$body),r.$trigger.addClass(c.ACTIVE).attr("aria-expanded","true"),t.addClass(c.IN),n.length)return;r.$body.append('<div id="overlay" class="offcanvas-overlay fixed-fs offcanvas--overlay" data-toggle="offcanvas" data-target="'+r.$trigger.attr("data-target")+'"></div>')}else s(!1,r.$body),r.$trigger.removeClass(c.ACTIVE).attr("aria-expanded","false"),t.removeClass(c.IN),n.remove();
// remove animation class
e(t)}function e(t){t.on("transitionend",function(){l(this).removeClass(c.IS_ANIMATING)})}function o(t){var n=l(t);u(g)||(v=!1,a(n))}
// =================== public methods ==================
function i(){t(),n()}
// =============== export public methods ===============
...
/* =============== export public methods =============== */var a={},o=!!l("body").hasClass("single-product"),i={cellAlign:"left",contain:!0,fullscreen:o},r={cellAlign:"left",contain:!0,pageDots:!1};return{init:e}}(),m=function(){"use strict";
// =================== private methods =================
function t(){r.$cartBtn=l(".single_add_to_cart_button"),r.$checkout=l(".site-header-cart"),r.$cartWidget=l(".widget_shopping_cart"),r.$btnLabel=l(".add_to_cart_label"),r.$btnLoader=l(".loader")}function n(){r.$cartBtn.on("click",function(t){e(t)})}function e(t){t.preventDefault();var e=l(t.currentTarget),n=e.parents("form").serialize()+"&"+encodeURI(e.attr("name"))+"="+encodeURI(e.attr("value"));e.attr("disabled",!0).button("toggle").addClass(c.UPDATING),a(!0),l.post(e.attr("action"),n+"&_wp_http_referer="+e.attr("action"),function(t){var n=l(".widget_shopping_cart",t);
...
//ADDED:           'added',
//LOADING:         'loading',
UPDATING:"updating",CHECKOUT_ACTIVE:"checkout--active",D_NONE:"d-none"};return{init:i}}(),p=function(){"use strict";
/* =================== private methods ================= */
...
/* =============== export public methods =============== */var i={},r={ACTIVE:"checkout--active"};return{init:o}}();
// You Ready for this?
l(document).ready(function(){o.init(),a.init(),i.init(),r.init(),c.init(),m.init(),p.init(),$.init(),h.init(),
// Init tooltips
