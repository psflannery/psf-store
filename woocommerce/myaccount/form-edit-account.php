...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="woocommerce-form-row woocommerce-form-row--first form-row-first form-group">
	...
	<div class="woocommerce-form-row woocommerce-form-row--last form-row-last form-group">
	...
	<div class="woocommerce-form-row woocommerce-form-row--wide form-row-wide form-group">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control" name="account_display_name" id="account_display_name" value="<?php echo esc_attr( $user->display_name ); ?>" /> <span class="small text-muted"><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></span>
	</div>
	<div class="woocommerce-form-row woocommerce-form-row--wide form-row-wide form-group">
