...
<table class="shop_table woocommerce-checkout-review-order-table table">
	<thead>
		<tr>
			<th class="product-name"><?php _e( 'Product', 'psf-store' ); ?></th>
			<th class="product-total text-right"><?php _e( 'Total', 'psf-store' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php _e( 'Subtotal', 'psf-store' ); ?></th>
